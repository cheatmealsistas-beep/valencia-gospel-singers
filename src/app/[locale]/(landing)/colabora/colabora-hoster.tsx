      ...
      <div className="container relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <FadeIn delay={0.1} className="order-2 lg:order-1">
            <div className="group relative p-8 rounded-3xl bg-[#141414] border border-[#2a2a2a] hover:border-amber-500/50 transition-all duration-500 overflow-hidden hover:shadow-xl hover:shadow-amber-500/10">
                ...
                <div className="grid sm:grid-cols-2 gap-6">
                  {benefits.map((benefit, index) => (
                    <div key={index} className="flex gap-4">
                      <div className="flex-shrink-0 w-10 h-10 rounded-xl bg-amber-500/10 flex items-center justify-center group-hover:scale-110 group-hover:rotate-3 transition-all duration-300">

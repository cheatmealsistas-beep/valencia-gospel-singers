      ...
      <div className="relative z-10 max-w-3xl mx-auto text-white">
        <FadeIn>
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl lg:text-7xl">
            {t('hero.titleStart')}{' '}
            <span className="bg-gradient-to-r from-purple-400 via-fuchsia-400 to-pink-400 bg-clip-text text-transparent animate-gradient-x bg-[length:200%_auto]" style={{ WebkitBackgroundClip: 'text' }}>{t('hero.titleHighlight')}</span>
          </h1>
        </FadeIn>
